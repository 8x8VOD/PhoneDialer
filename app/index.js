                ...
                <div className="keyRow">
                  ...
                  <div className="moreEllipsisMenu">
                    <div className="moreMenu moreEllipsisMenuTrans">
                      <ul>
                        <li onClick={this.onDialPadClick}>
                          <div><i className="fa fa-th" /></div>
                          <div>Dialpad</div>
                        </li>
                        <li onClick={this.onAddCallClick}>
                          <div><i className="fa fa-plus" /></div>
                          <div>Add Call</div>
                        </li>
                        <li onClick={this.onTransferCallClick}>
                          <div><i className="fa fa-phone" /></div>
                          <div>Transfer</div>
                        </li>
                        <li onClick={this.onRecordClick}>
                          <div><i className="fa fa-dot-circle-o" /></div>
                          <div>Record</div>
                        </li>
                        <li onClick={this.onHoldClick}>
                          <div><i className="fa fa-pause" /></div>
                          <div>Hold</div>
                        </li>
                        <li onClick={this.onParkClick}>
                          <div><i className="fa fa-map-pin" /></div>
                          <div>Park</div>
                        </li>
                      </ul>

                      <div className="triangle-down" />
                      <div className="triangle-down sh" />
                    </div>
...
PhoneDialer.propTypes = {
  ...
  onCallInfoText: PropTypes.string.isRequired,
